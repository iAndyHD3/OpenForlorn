...
extern std::wstring programName;
...
bool MainScene::init()
{
    printf("AAAAAAAAAA %ls", programName.c_str());
    //////////////////////////////
    // 1. super init first
    if (!Scene::init())
    {
    ...
    extension::Inspector::getInstance()->openForCurrentScene();
...
{
    auto plArgs = PlayLayer::Args{};
    auto pl = utils::createInstance<PlayLayer>(&PlayLayer::init, plArgs);

    _director->replaceScene(pl);
}
